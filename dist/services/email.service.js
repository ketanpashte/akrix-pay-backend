...
let EmailService = EmailService_1 = class EmailService {
    ...
    async sendReceiptToClient(clientEmail, clientName, amount, receiptBuffer, receiptNumber) {
        try {
            const mailOptions = {
    ...
    async sendPaymentNotificationToAkrix(clientName, clientEmail, amount, receiptBuffer, receiptNumber) {
        try {
